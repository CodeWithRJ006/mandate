            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl shadow-xl">
              ...
              <div className="text-slate-300 text-sm leading-relaxed space-y-4">
                ...
                <div className="border-t border-slate-800/50 pt-4 mt-4 text-slate-200">
                  ...
                  <p className="mb-2">
                    This is the true safe floor: it maximizes authorized throughput (driving Tuning FPR down to 7.7%) while maintaining a rigorous safety margin against known adversarial mutations.
                  </p>
                  <p className="mb-2">
                    <strong className="text-amber-400">The Tradeoff:</strong> The residual 7.7% Tuning FPR consists entirely of genuine semantic variants that character-level bigram algorithms cannot comprehend—such as &quot;USB-C Cable 1m&quot; vs &quot;USB C Cable, 1 Meter&quot; (which scores a dismal 0.538) or &quot;Bluetooth Speaker&quot; vs &quot;BT Speaker&quot; (0.461). We intentionally accept that these perfectly benign abbreviations will fall below the 0.60 threshold and require manual review, because lowering the threshold to automatically approve them would open the floodgates to the &quot;iPhone 13 Mini&quot; substitution attack.
                  </p>
                  <p className="text-xs text-slate-500 italic mt-2">
                    (Note: The Live Evaluation matrix above currently shows a 0.0% FPR because the stratified shuffle randomly placed our hardest semantic boundary cases into the 70% offline Tuning Set rather than the 30% Held-Out set. Additionally, our 48-case offline dataset is intentionally saturated with boundary and adversarial cases to stress-test the engine, artificially inflating the FPR relative to a normal, predominantly clean production distribution).
                  </p>
                </div>
              </div>
            </div>
